            ...
            if (localStorage.getItem('tutorialShown') !== 'true') {
                introJs().setOptions({
                    steps: [
                        ...
                        { element: document.querySelector('#feature1'), intro: "Dê uma olhada nas suas entradas do diário registradas!" },
                        { element: document.querySelector('#feature2'), intro: "Aqui estão seus eventos pendentes!" },
                        { element: document.querySelector('#feature3'), intro: "Aqui estão suas atividades pendentes!" },
                        { element: document.querySelector('#feature4'), intro: "Aqui estão seus compromissos futuros!" },
                        { element: document.querySelector('#feature5'), intro: "Gerencie seu tempo e veja suas horas livres!" },
                        { element: document.querySelector('#feature1'), intro: "Por último, você pode adicionar novas notas aqui!" }
                    ],
                    showBullets: false,
                    showButtons: true,
                    nextLabel: 'Próximo',
