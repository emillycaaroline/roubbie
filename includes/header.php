...
@media (max-width: 767.98px) {
    ...
    .navbar-nav .nav-item .nav-link {
        font-size: 12px; /* Ajuste o tamanho conforme necessário para dispositivos móveis */
    }
}
                    ...
                    <ul class="nav-menu">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarUserDropdownMenuLink">
                                ...
                                <li><a class="dropdown-item" href="http://localhost/roubbie/login-register/cadastro.html"><i class="bi bi-person"></i> Cadastro</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
