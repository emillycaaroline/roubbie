...
body {
    ...
    margin: 0;
    padding: 0;
    background-color: #f4f9fc; /* Um azul claro e suave */
}

header {
    background: linear-gradient(90deg, #FF6F61, #FF8E3C); /* Gradiente quente */
    color: white;
    padding: 40px 0;
    text-align: center;
...
.funcionalidade {
    ...
    position: relative; /* Para permitir posicionamento de elementos de fundo */
}
...
.cta a {
    padding: 15px 30px;
    background: #28A745; /* Verde vibrante */
    color: white;
